...
const Conversation = ({
  ...
  return (
    <div
      ...
      className="flex flex-grow items-center overflow-hidden hover:cursor-pointer hover:bg-[#f5f7f9] px-4 py-4"
    >
      ...
      <div className="pl-2 flex-grow overflow-hidden">
        <div className="text-sm text-gray-700 mb-1">{username}</div>
        <div className="flex">
          <div className="truncate overflow-hidden text-xs flex-grow text-gray-400">
            {last_message}
          </div>
